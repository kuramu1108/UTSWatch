<html lang="en"><head>
  ...
  <body>
    ...
    </script><div><div style="position: absolute; top: 10px; width: 100%; text-align: center;"><a href="http://threejs.org" target="_blank"></a> <h2>pixel printer</h2> <br><strong>click</strong>: add voxel, <strong>control + click</strong>: remove voxel, <strong>shift + mousemove</strong>: rotate, <a href="javascript:save();">save .stl</a></div><canvas width="553" height="577" style="width: 553px; height: 577px;"></canvas></div>
